    ...
    <footer className={styles.footer}>
      <div className={styles.content} >
        ...
        <div className={styles.social} >
            <Link href="https://www.instagram.com/hignition"> <Instagram color="#121212" size={20} /> </Link>
            <Link href="/"> <X color="#121212" size={20} /> </Link>
            <Link href="https://www.linkedin.com/company/104028268"> <Linkedin color="#121212" size={20} /> </Link>
        </div>
        </div>
        ...
        <div className={styles.options}>
          ...
          <ul>
            ...
            <li><Link href="https://form.typeform.com/to/wMLy2PQ4" >Agenda Una Demostración</Link></li>
          </ul>
          </div>
          <div>
          <h4>Planes</h4>
