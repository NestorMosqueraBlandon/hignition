  ...
  return (
    ...
    <div className={styles.container}>
      <div className={styles.portrait} >
        ...
        <h4>Con menos estrés y más estabilidad. Si no estás <br /> satisfecho. te devolvemos el dinero.</h4>
        <div className={styles.buttons} >
          <button className={styles.white}><Link href="https://form.typeform.com/to/wMLy2PQ4">Ver Planes</Link></button>
          <Button href='https://form.typeform.com/to/wMLy2PQ4'>Agendar una Demostración</Button>
        </div>
    </div>
  </section>
